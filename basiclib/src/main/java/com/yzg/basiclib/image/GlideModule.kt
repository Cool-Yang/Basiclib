package com.yzg.basiclib.image
...
//            com.sixx.dcpay.common.glide.OkHttpGlideUrlLoader.Factory(okHttpClient)
//        )

//        val builder =  OkHttpClient.Builder()
//        builder.addInterceptor(ProgressInterceptor());  //拦截器
